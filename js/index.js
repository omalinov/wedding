...
function doRooms() {
    const rooms = {
        ...
        "Панайот Стефанов": { house: "Estera Vini Къща 2", floor: 2, room: 3, roomType: "две легла", duration: 1, pricePerNight: 120 },
        "Росица Стефанова": { house: "Estera Vini Къща 2", floor: 2, room: 3, roomType: "две легла", duration: 1, pricePerNight: 120 },
        ...
        "Екатерина Тянкова": { house: "Estera Vini Къща 3", floor: 2, room: 3, roomType: "спалня", duration: 2, pricePerNight: 120 },
        "Ondrej Vanek": { house: "Estera Vini Къща 3", floor: 2, room: 3, roomType: "спалня", duration: 2, pricePerNight: 120 },
        ...
        "Панко Тянков": { house: "Estera Vini Къща 4", floor: 2, room: 2, roomType: "две легла", duration: 2, pricePerNight: 120 },
        "Кирил Тянков": { house: "Estera Vini Къща 4", floor: 2, room: 2, roomType: "две легла", duration: 2, pricePerNight: 120 },

        "Стефан Стефанов": { house: "Estera Vini Къща 4", floor: 2, room: 3, roomType: "спалня", duration: 1, pricePerNight: 120 },
        "Кристиан Стефанов": { house: "Estera Vini Къща 4", floor: 2, room: 3, roomType: "спалня", duration: 1, pricePerNight: 120 },
        ...
        "Атанас Анчев": { house: "Къща Анита & Релакс", floor: 2, room: 5, roomType: "спалня", duration: 1, pricePerNight: 100 },
        "Мирена Младенова": { house: "Къща Анита & Релакс", floor: 2, room: 5, roomType: "спалня", duration: 1, pricePerNight: 100 },

        "Боян Каназирски": { house: "Къща Анита & Релакс", floor: 3, room: 6, roomType: "спалня", duration: 1, pricePerNight: 120 },

        "Георги Араламов": { house: "Къща Анита & Релакс", floor: 3, room: 7, roomType: "две легла", duration: 1, pricePerNight: 100 },
        "Теодор Велев": { house: "Къща Анита & Релакс", floor: 3, room: 7, roomType: "две легла", duration: 1, pricePerNight: 100 },
        ...
        "Екатерина Бургова": { house: "Къща Анита", floor: 2, room: 2, roomType: "две легла", duration: 1, pricePerNight: 80 },
        ...
        "Мариана Спасова": { house: "Къща Анита", floor: 3, room: 6, roomType: "спалня", duration: 1, pricePerNight: 80 },
        "Петър Спасов": { house: "Къща Анита", floor: 3, room: 6, roomType: "спалня", duration: 1, pricePerNight: 80 },
    };
...
Църковната церемония ще се състои в храм „Свети Атанасий“, разположен в центъра на град Перущица.
</br>
</br>
Всички гости са поканени да споделят този момент с нас.
</br>
</br>
Посрещането пред храма ще започне в <strong>15:00 ч.</strong>, а тържествената церемония ще започне в <strong>15:30 ч.</strong>
</br>
</br>
<strong>Как да стигнете до църквата?</strong>
</br>
За Ваше удобство е осигурен транспорт от Пловдив, който ще тръгне от <strong>спирката срещу хотел "Тримонциум" в 14:00 ч.</strong> и ще пристигне <strong>пред църквата около 14:45 ч.</strong> Всички гости са добре дошли да се възползват от тази услуга.
</br>
</br>
<strong>Молим Ви да ни уведомите предварително, ако желаете да използвате транспорта!</strong>
</br>
</br>
За гостите, които ще нощуват в <strong>Anita Guest House</strong> или <strong>Anita Relax Guest House</strong>, църквата се намира на около 5 минути пеша.
</br>
</br>
Esterra Vini Guest House е разположена на приблизително <strong>4км</strong> от църквата или около <strong>5–10 минути с автомобил</strong>.`,
    "welcome_drink_details_header": "Коктейл",
    "welcome_drink_details": `
<strong>Добре дошли в Esterra Vini - 17:00 ч.</strong>
</br>
<strong>Esterra Vini</strong> е  нашето специално място за сватбеното тържество. При пристигането ви ще бъдете посрещнати с разнообразие от напитки и леки хапки — включително различни студени алкохолни и безалкохолни напитки.
</br>
</br>
...
От Пловдив до Esterra Vini са около <strong>25 км</strong>, което се изминава за приблизително <strong>30 минути с автомобил</strong> по главния път към Перущица и след това по малък път, където се намира мястото.
</br>
</br>
...
Обособен  паркинг предоставят и къщите за гости  Anita Guest House и Anita Relax Guest House.
</br>
</br>
...
<ul>
<li>Esterra Vini – част от комплекса на мястото на сватбеното тържество.</li>
<li>Къщи за гости в центъра на Перущица – Anita Guest House и Anita Relax Guest House. Двете къщи за гости са в един двор.</li>
</ul>
<strong>Часове за настаняване и напускане</strong>
<ul>
<strong><li>Настаняване</strong>: между 14:00 ч. - 18:00 ч. -  всеки ден.</li>
<strong><li>Освобождаване</strong>: до 11:00 ч. на 13 септември.</li>
<strong><li>Заплащане</strong>: всеки гост заплаща индивидуално на рецепцията при настаняване.</li>
</ul>
<strong>Препоръчително време за настаняване</strong>
</br>
В деня на сватбата между 14:00 и 15:30 ч., за да имате време спокойно да получите ключовете и да оставите багажа си преди началото на сватбената програма.
</br>
</br>
В Esterra Vini рецепцията се намира в Къща №1.
</br>
</br>
Всички, които са заявили настаняване, могат да открият подробности в <strong>секцията „Детайли на настаняване“ по-долу.</strong>
</br>
</br>
<strong>Вечерен транспорт</strong>
</br>
За гостите, настанени в Перущица, е осигурен вечерен транспорт, който ще обслужва маршрута между Esterra Vini и къщите за гости, както следва:
<ul>
<li><strong>Първи курс</strong>: 22:00 ч.</li>
<li><strong>Последен курс</strong>: 04:00 ч.</li>
...
Ако планирате да използвате такси услуга или drink & drive до Пловдив, Ви съветваме да резервирате предварително, тъй като местните възможности в късните часове може да бъдат ограничени.
</br>
</br>
<strong>Контакти за настаняване</strong>
<ul>
<li>Телефон: +359 884 675 777</li>
<li>Email: reservations@anita.bg</li>
</ul>`,
    ...
    "photos_link": "тук",
    "photos-note": "Трябва да сте влязли в гугъл профила си. Ако качвате от телефон трябва да го правите през Google Drive приложението, защото браузърите крият бутона за качване.",
    "gallery": "Галерия",
    ...
    "faq-text-3": "Настаняване е възможно в Anita Guest House и Anita Relax Guest House в центъра на Перущица (около 5 минути пеша от църквата) или в Esterra Vini, което е на мястото на тържеството. За всички заявили е направени резервация, която може да платите при настаняване на рецепцията с карта или в брой.",

    "faq-title-4": "Какви са часовете за настаняване и напускане?",
    "faq-text-4": "Настаняването е между 14:00 и 18:00 ч. всеки ден. Освобождаването на стаите е до 11:00 ч. на 13 септември.",

    "faq-title-5": "Как мога да се върна до къщите за гости след тържеството?",
    "faq-text-5": "За гостите настанени в Перущица е осигурен вечерен транспорт от Esterra Vini до къщите и обратно, на всеки кръгъл час от 22:00 до 04:00 ч. Ако имате нужда от транспорт извън този график, може да се обърнете към шофьора на колата.",

    "faq-title-6": "Как да стигна без да шофирам?",
    ...
    "faq-text-7": "Да, ние сме направили всички необходими резервации и сме осигурили стаи за всички, които заявиха настаняване. Моля, погледнете секцията „Детайли на настаняване“ за повече информация относно вашата стая.",
...
`,
    ...
    "photos_link": "here",
    "photos-note": "You should be logged in into your google profile. If you're uploading through a phone you should do it through the Google Drive app as browsers hide the upload button.",
    "gallery": "Gallery",
